...
_G.packer_plugins = {
  ...
  ["nvim-tmux-navigation"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/nvim-tmux-navigation",
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/presence.nvim",
  ...
  ["vim-godot"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-godot",
